...
from altero.exceptions import ConfigError, SwitchError
...
class TestJsonHelpers:
    ...
    def test_account_row_includes_alias_when_set(self):
        from altero.json_output import account_row
...
class TestListJson:
    ...
    def test_list_payload(
        ...
        with patch.object(switcher, "_read_active_credentials",
             ...
             patch("altero.oauth.try_fetch_usage_for_account", return_value=oauth.UsageOutcome(usage)):
            payload = switcher.list_accounts(json_output=True)
    ...
    def test_stale_usage_is_decision_gated_in_json(
        ...
        from altero.usage_store import FetchRecord, UsageStore
