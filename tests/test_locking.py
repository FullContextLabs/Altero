...
class TestSurfaceRegistry:
    ...
    def test_a_registered_surface_is_live(self, tmp_path):
        from altero.locking import live_surfaces, register_surface
    ...
    def test_a_released_surface_is_gone_and_its_file_cleaned(self, tmp_path):
        from altero.locking import live_surfaces, register_surface, surfaces_dir
    ...
    def test_a_dead_process_does_not_count(self, tmp_path):
        ...
        from altero.locking import live_surfaces

        script = textwrap.dedent(
            f"""
            from pathlib import Path
            from altero.locking import register_surface
