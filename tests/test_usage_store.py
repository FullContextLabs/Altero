...
from altero import oauth, usage_store
...
class TestBackoff:
    ...
    def test_each_arm_is_bounded_by_the_ceiling_its_own_trust_uses(self):
        ...
        introduced against the base branch, where `RETRY_AFTER_FLOOR_CAP_S` was
    ...
    def test_park_bound_blind_window_equals_age_at_failure(self, tmp_path):
        ...
        arm, and this is pre-existing the previous code behaviour left open
        ...
        past that, compared to the previous code. See the PARK BOUND comment.
        """
...
class TestFingerprintBoundStrikes:
    ...
    def _store(self, tmp_path):
        from altero.usage_store import UsageStore
