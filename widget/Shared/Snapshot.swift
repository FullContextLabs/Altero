...
/// The `altero snapshot` document (schema v1), as the widget reads it.
///
/// The producer is `src/altero/snapshot_json.py`; the schema contract is
...
struct Window: Decodable, Sendable {
    ...
    /// (see `usage_summary` in `src/altero/menubar.py`).
    var marker: Marker {
