...
struct AlteroConfigIntent: WidgetConfigurationIntent {
    static let title: LocalizedStringResource = "Altero"
...
struct PageIntent: AppIntent {
    static let title: LocalizedStringResource = "Change Altero widget page"
    ...
    func perform() async throws -> some IntentResult {
        ...
        WidgetCenter.shared.reloadTimelines(ofKind: AlteroWidget.kind)
        return .result()
    }
}
...
struct SelectAccountIntent: AppIntent {
    static let title: LocalizedStringResource = "Show account in Altero widget"
    static let isDiscoverable = false
...
struct ShowDetailIntent: AppIntent {
    static let title: LocalizedStringResource = "Show account details in Altero widget"
    static let isDiscoverable = false
...
struct BackToListIntent: AppIntent {
    static let title: LocalizedStringResource = "Back to the Altero widget account list"
    static let isDiscoverable = false
...
struct ScrollListIntent: AppIntent {
    static let title: LocalizedStringResource = "Scroll Altero widget list"
    static let isDiscoverable = false
...
struct RefreshIntent: AppIntent {
    static let title: LocalizedStringResource = "Refresh Altero widget"
    static let isDiscoverable = false
...
/// The auto-switch toggle. The widget cannot change altero's settings itself:
...
struct SetAutoswitchIntent: SetValueIntent {
    static let title: LocalizedStringResource = "Turn Altero auto-switch on or off"
    static let isDiscoverable = false
...
struct SwitchAccountIntent: AppIntent {
    static let title: LocalizedStringResource = "Switch Claude account from the Altero widget"
    static let isDiscoverable = false
