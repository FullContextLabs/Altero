...
/// extension, which cannot exec altero. The link opens
/// `altero://start-backend`, which LaunchServices hands to the host app
/// (unsandboxed, no Dock icon); it runs `altero service start` and quits. This
