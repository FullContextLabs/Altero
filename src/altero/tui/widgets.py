...
from altero import pace
from altero.json_output import USAGE_API_KEY
from altero.models import AccountSnapshot
from altero.switcher import ERROR_NOTES
from altero.usage_store import STALE_OK_S
...
def usage_rows(
    ...
    week's expected usage — never the 5h row.
    """
...
def account_card_text(
    ...
    *,
    ...
    if sentinel is not None:
        ...
        # Same supplementary line `altero list` prints: the last good
...
class AccountsPanel(Static):
    ...
    def render(self) -> Text:
        app: "AlteroApp" = self.app  # type: ignore[assignment]
