...
``altero.snapshot_source.SnapshotSource`` (shared with any GUI shell);
...
from altero import oauth, printer, usage_store
from altero.exceptions import ClaudeSwitchError
from altero.snapshot_source import SnapshotSource
from altero.switcher import SENTINEL_NOTES, last_seen_note
...
def sentinel_label(sentinel: str) -> str:
    """The same wording ``altero list`` prints for this sentinel state."""
