...
every few seconds and a one-shot ``altero list`` produce identical network
behavior. This class therefore just runs the same on-demand pass as ``altero
...
from altero.json_output import USAGE_TOKEN_EXPIRED
